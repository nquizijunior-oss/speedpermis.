...
import { EnjeuxCarousel } from '../first-site-components/EnjeuxCarousel';
import { RelatedArticles } from '../first-site-components/RelatedArticles';
  ...
  return (
    <ul className="mt-4 space-y-4">
      ...
      <li key={item} className="flex gap-4 text-[15px] leading-relaxed text-muted">
          <span
          aria-hidden="true"
          className="mt-2 h-2 w-2 shrink-0 rounded-full bg-gov-blue" />
      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="mx-auto max-w-content">
          <nav
            ...
            className="flex flex-wrap items-center gap-3 py-6 text-[14px] text-muted">
            
            <a
              href="#"
              aria-label="Accueil"
              className="text-ink transition-colors duration-150 ease-out hover:text-gov-blue">
            ...
            <a
              href="#"
              className="transition-colors duration-150 ease-out hover:text-gov-blue">
              
              Inscription et formation
            </a>
            <ChevronRightIcon className="h-4 w-4 text-neutral-400" aria-hidden="true" />
            <span aria-current="page">Réserver en ligne sa place pour le permis</span>
          </nav>

          <h1 className="font-display text-[34px] font-bold leading-tight text-ink sm:text-[42px]">
            Réserver en ligne sa place pour le permis
          </h1>
          ...
          <ul className="mt-7 flex items-center gap-4">
            ...
            <li key={label}>
                ...
                href="#"
                aria-label={label}
                className="flex h-11 w-11 items-center justify-center rounded-full border border-neutral-400 text-ink transition-[colors,transform] duration-150 ease-out hover:border-gov-blue hover:text-gov-blue focus:outline-none focus-visible:ring-2 focus-visible:ring-gov-blue focus-visible:ring-offset-2">
          ...
          <p className="mt-10 text-[15px] font-bold leading-relaxed text-ink">
            La Sécurité routière a mis en place une nouvelle plateforme qui permet de
            réserver en ligne son rendez-vous pour l’examen pratique du permis de
            conduire : RdvPermis.
          </p>
          ...
          <p className="mt-5 text-[15px] leading-relaxed text-muted">
            RdvPermis est un système de réservation nominative des places à destination
            des candidats qui en font la demande par voie électronique soit par le biais
            de leur auto-école soit via leur propre compte sur le site de réservation.
          </p>

          <div className="mt-10 grid items-stretch gap-8 sm:grid-cols-2">
            <ConnectBlock
              title="Je suis candidat"
              subtitle="inscrit dans un des départements concernés" />
            
            <ConnectBlock
              title="Je suis une école de conduite"
              subtitle="proposant une offre de formation dans un des départements concernés" />
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-muted">
            Il vous suffit de vous connecter avec les identifiants que votre auto-école
            vous a fournis pour accéder à la plateforme.
          </p>
          <p className="mt-6 text-[15px] font-bold text-ink">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-muted">
            Une fois connecté en tant que candidat, vous pouvez accéder à plusieurs
            fonctionnalités :
          </p>
          ...
          <p className="mt-8 text-[15px] font-bold text-ink">
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-muted">
            Dans le cadre de la réforme du permis de conduire, le Gouvernement s&apos;est
            engagé à moderniser l&apos;inscription à l&apos;épreuve pratique du permis de
            conduire.
          </p>
          <p className="mt-5 text-[15px] leading-relaxed text-muted">
            Cette nouvelle plateforme répond à trois grands enjeux :
          </p>
